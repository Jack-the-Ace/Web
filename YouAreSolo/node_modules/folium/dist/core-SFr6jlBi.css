/*
Original work Copyright (c) 2023 Emil Kowalski
Modified work Copyright (c) 2025 by iSaulX
Licensed under the MIT License. 
*/

/**This prevents layout shifting when the drawer is open */
html {
...
[data-vaul-drawer][data-vaul-delayed-snap-points="true"][data-vaul-drawer-direction="left"] {
	transform: translateX(var(--snap-point-height, 0));
}
...
[data-vaul-drawer]:not([data-vaul-custom-container="true"])::after {
	...
	background: inherit;
	pointer-events: none;
	background-color: var(--drawer-bg-data-color, inherit);
	height: 0;
}
