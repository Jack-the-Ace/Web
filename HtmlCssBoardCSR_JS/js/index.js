...
// JS는 헤더에 추가되어있고, 게시글을 추가해야 하는 table 요소는 body에 있기에
// body가 완료된 후 DOM 작업을 수행해야 함.

// 방법 2가지
// 1. body 요소에 onload 이벤트 적용
...
function loaded(){
    ...
    // 먼저 web_board 테이블에서 모든 데이터를 읽어와서 json으로 응답해주는 php코드 작성
    
    // JS에서 페이지의 변경 없이 서버에서 데이터만 요청하는 기법을 AJAX 라고함
